...
VALUES (1,"Rua Carlos Wagner","1434","Aviação","Venâncio Aires","RS","95800-000"),
...
VALUES (1, "Darlei","Feix","029.029.029-29","M","darleifeix97@gmail.com","993423747","1997-05-30"),
...
INSERT INTO PUBLISHER(NOME, ID_PAIS)
VALUES ("Eletronic Arts", 1),
	("Ubisoft", 2),
    ("Microsoft", 3),
    ("Rockstar Games", 4),
    ("Sony", 5);
...
INSERT INTO PRODUTOS(ID_PUBLISHER, ID_PLATAFORMA, NOME, DATA_LANCAMENTO, PRECO_COMPRA, PRECO_VENDA, CLASSIFICACAO, DESCRICAO, ESTOQUE)
VALUES (1,7,"FIFA 22","2021-09-27",49.90,99.99,"Livre","FIFA 22 é o novo jogo da renomada franquia de futebol, utilizando a tecnologia HyperMotion de última geração, que integra dados avançados de movimento de equipe e aprendizado de máquina para melhorar a jogabilidade.", 10),
	(1, 3,"FIFA 22","2021-09-27",49.90,99.99,"Livre","FIFA 22 é o novo jogo da renomada franquia de futebol, utilizando a tecnologia HyperMotion de última geração, que integra dados avançados de movimento de equipe e aprendizado de máquina para melhorar a jogabilidade.", 10),
...
VALUES (6, "Jorge","Anthony","246.640.381-19","jorge_anthony_souza@bom.com.br","(68) 3564-2078"),
...
VALUES (1,1,3,"2022-05-30",50,10),
	(4,2,2,"2022-04-14",50,10),
    (5,2,5,"2022-11-22",50,10),
    (3,3,4,"2021-09-11",50,10),
    (2,4,1,"2022-06-15",50,10);
